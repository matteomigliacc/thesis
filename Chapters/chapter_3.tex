...
While investigating potential infringements, \glspl{sa} can make reciprocal requests for mutual assistance.\autocite[60(2)]{GDPR} 
...
An \gls{lsa} can follow the objections presented, and adjust the draft decision accordingly within two weeks.\autocite[60(5)]{GDPR}
...
The \gls{lsa} then is required to inform the controller/processor of the adoption of the decision, as well as the \glspl{sac} and the \gls{edpb}.
...
Finally, as part of the consistency mechanism, \glspl{sa} may trigger an urgency procedure when there is an urgent need to act to protect the rights and freedoms of data subjects.\autocite[66(1)]{GDPR}
