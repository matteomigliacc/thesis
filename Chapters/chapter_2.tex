...
The work of the Court in this regard was not a mere comparative study of the principles that underpinned MS' legal systems, but rather an investigation of the `best' interpretation of shared values in light of the objectives of the Treaties.\autocites[270]{craigFoundations2018}[See also][point 69]{audioluxAG}
...
`Good administration' appears in the Union legal order both as a general principle of EU law and as a fundamental right enshrined in the CFR. 
This section will deal with the two sources of this right in the EU's legal system, and provide an analysis between the two.
...
Hofmann observes how the lack of systematic harmonization of administrative law exacerbates this problem in the EU.\autocite[137]{hofmannCompositeDecisionMaking2009}
...
While it had been accepted by the Courts that the right to effective judicial protection would not be infringed upon as long as an ex-post judicial review of administrative acts was available, the institutional complexity of the EU has made it increasingly difficult to challenge the discretionary power of national administrations.\autocite[85–86]{mihaescu-evansRightGoodAdministration2015}
...
This section will explore the requirements of the sub-principles of good administration that are most relevant to the enforcement model of the GDPR as amended by the Procedural Regulation, namely the duty of care and the duty to give reasons.

\subsubsection{The duty of care of the administration}

The principle of good administration was initially developed by the CJEU when referring to the duty of the administration to be careful in its information-gathering prior to reaching a decision.\autocite[195]{hofmannAdministrativeLawPolicy2012}
...
After considering the aspects of the duty of care and the duty to give reasons within the principle of good administration, we can now turn to the specific features of the GDPR's enforcement model.
This section will explore the design of the cooperation and consistency mechanism of the GDPR as a decentralized enforcement network, and explore the role of the duty to give careful and reasoned decisions in its context.

\subsubsection{The GDPR's cooperation mechanism as an enforcement network}

Within the cooperation and consistency mechanism of the GDPR, we notice a network of horizontal cooperation between DPAs, with the EDPB serving as a vertical norm-setter and decision-maker.\autocites[140]{hofmannCompositeDecisionMaking2009}[18–22]{mustertCrossborderEnforcementGDPR}
...
The cross-border enforcement model of the GDPR is heavily based on cooperation through information exchange.\autocite[140]{hofmannCompositeDecisionMaking2009}
The LSA and SACs must reach consensus on every stage of the procedure,\autocite[465]{hofmannmustertScholtenHandbook2023} and in doing so, they must share information,\autocite[60(1)]{GDPR} provide mutual assistance to each other, and participate in joint operations.\autocite[60(2)]{GDPR}
On the other hand, the EDPB acts as a central node in the enforcement network, providing support to the DPAs while discharging their duties.\autocite[467]{hofmannmustertScholtenHandbook2023} 
DPAs can request opinions or binding decisions from the EDPB, and use the EDPB as a dispute settlement forum in case of disagreements during the cross-border enforcement procedure.\autocite[467–468]{hofmannmustertScholtenHandbook2023}

\subsubsection{The collective duty of enforcement}

As explored in section 2.2.1, the design of the GDPR's cross-border enforcement model qualifies as a composite administrative procedure, where the LSA leads the procedure and is the sole interlocutor of the accused, but has to consult SACs to reach a common enforcement outcome.\autocite[63]{facebookBelgium}

As the CJEU affirmed in \emph{Facebook Belgium}, the one-stop-shop mechanism of the GDPR does not relieve the DPAs of their collective duty to ensure the application of the GDPR and the protection of data subjects' fundamental right to data protection.\autocite[63–68]{facebookBelgium} 
AG Bobek further argued that an LSA must act as a \emph{primus inter pares}, acting only with the consent of the SACs.\autocite[point 111]{fbBelgiumAgBobek}

\todo[inline]{Talk about subsidiarity and proximity here? + connect to Hofmann on composite decision making}

However, a collective duty of enforcement can only be discharged by all DPAs if they are able to access all relevant information about a case, and if there is clear understanding behind the choices made in the information-gathering stages.

\subsubsection{Locating the duty of care and the duty to give reasons in the GDPR's enforcement model}

The duty to deliver careful and reasoned decisions becomes particularly important in the integrated administrative model of the GDPR, especially when considering the objective facet of the principle of good administration.\autocite[114]{mihaescu-evansRightGoodAdministration2015}

The duty of care of DPAs has already appeared in the case law of the CJEU. 
The Court has ruled that DPAs must examine complaints ``with all due diligence'',\autocites[63]{SchremsI}[68]{SCHUFA} meaning that they must ``examine the nature of that complaint as necessary''.\autocites[109]{SchremsII}[37]{mustertCrossborderEnforcementGDPR} 
Under the framework of the GDPR, this duty of care will only be discharged through extensive information-gathering and cooperation between the LSA and the SACs, so that all relevant aspects of a case can be taken into account by the LSA when drafting a decision.

Similarly, recalling the functions of the duty to give reasons laid out by Craig,\autocite[369–370]{craigProcess2018} a close collaboration between DPAs in a cross-border case could aid the integrated system of the GDPR as a whole to check the quality of its assessments, ensuring that the final decision is based on lawful and well-reasoned grounds.
The duty to give reasons also comes into play in the context of dispute settlement, where the EDPB needs to provide a binding decision based on the assessments and the objections of the DPAs involved in the procedure.

However, as evidenced by Lynskey and Gentile, when an LSA narrows the scope of the investigation and fails to collect evidence on a contested point of law, the EDPB might not have enough elements to conduct a thorough review of the case, the quality of the draft decision of the LSA, and the reasoning behind the objections of the SACs.\autocite[810]{gentileDeficientDesign2022}

The Procedural Regulation introduces a number of procedural steps to mandate consensus-building and information exchange between DPAs, and will be dealt with in the next chapter.